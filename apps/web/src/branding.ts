...
export const APP_BASE_NAME = injectedDesktopAppBranding?.baseName ?? "Magie";
...
export function replaceLegacyAppName(value: string): string;
export function replaceLegacyAppName(value: null | undefined): null | undefined;
export function replaceLegacyAppName(value: string | null | undefined): string | null | undefined;
export function replaceLegacyAppName(value: string | null | undefined): string | null | undefined {
  return value === null ? null : value?.replaceAll("T3 Code", APP_BASE_NAME);
}
